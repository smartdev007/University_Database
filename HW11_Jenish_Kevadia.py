...
class Repository:
    ...
    def __init__(self, dir, pt=True):
        ...
        try:
            ...
            if pt:
                ...
                print(f'******** Instructor summary table using database ********')
    ...
    def instructor_table_db(self, db_path = 'C:\\Jenish\\Python-SSW810B\\testdb.db'):
        """ Summary of instructor table by fetching data from database """
        try:
        ...
        ptable = PrettyTable(field_names = ['CWID', 'Name', 'Dept', 'Course', 'Students'])
